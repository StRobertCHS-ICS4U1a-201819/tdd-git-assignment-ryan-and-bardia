...
def test_mean2():
<<<<<<< HEAD
    assert (mean([3,54,23,1,21,32,2,1,-54,23])==10.6)
def test_mean3():
    assert (mean([43,2,-213,-32,12,3411,-1024,2343,21,-33,-212])==392.55)
=======
...
'''
def test_range1():
    assert (range([1,2,3,4,5,6,7,8,9,19])==18)
def test_range2():
    assert (range([324,532,-32,-432,23,12,2341,34,2,4])==2773)
def test_range3():
    assert (range([23,12,312,12,0,23,12])==312)
'''
'''
def test_variance1():
    assert (variance([6,2,3,1])==3.5)
def test_variance2():
    assert (variance([32,12,1,23,2,9,24,6])==113.73)
def test_variance3():
